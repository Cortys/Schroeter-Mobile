	...
	$("#loadedPage,#subNav").cssFadeOut(startUp, function() {
		if(!did) {
			...
			prel.onload = function() {
				$.get("file:///android_asset/www/content/pages/"+(PHONE?"mobile":"tablet")+"/"+LANGUAGE+"/"+page+".html", { page:page, lang:LANGUAGE, phone:PHONE*1, phoneString:PHONESTRING }, function(data) {
